...
namespace My {
    ...
    {
        My::Type::Chat::ObjDataReader *ChatObject_reader = NULL;
        My::Type::Chat::ObjSeq data_seq;
        SampleInfoSeq info_seq;
        ReturnCode_t retcode;
        int i;

        ChatObject_reader = My::Type::Chat::ObjDataReader::narrow(reader);
        ...
        for (i = 0; i < data_seq.length(); ++i) {
            if (info_seq[i].valid_data) {
                ...
                My::Type::Chat::ObjTypeSupport::print_data(&data_seq[i]);
            }
        }
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    My::Type::Chat::ObjDataReader * reader = NULL;
    ...
    retcode = TheParticipantFactory->register_type_support(
                                My::Type::Chat::ObjTypeSupport::register_type,
    ...
    reader = My::Type::Chat::ObjDataReader::narrow(
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("My::Type::Chat::Obj subscriber waiting for %d sec...\n",
        receive_period.sec);

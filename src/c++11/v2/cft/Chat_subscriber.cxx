...
int subscriber_main(int domain_id, int sample_count)
{
    ...
    dds::topic::Topic<My::Type::Chat::Obj> topic(participant, My::Topic::Chat::TOPIC, My::Topic::Chat::TYPE);

    // Create a Content Filtered Topic
    std::vector< std::string > params = {"'Rajive'", "'Sander'"};
    dds::topic::Filter filter("(id = %0 OR id = %1)", params);
    dds::topic::ContentFilteredTopic<My::Type::Chat::Obj> cftopic(
    		topic, "Chat/filtered", filter);

    // Create a DataReader with default Qos (Subscriber created in-line)
    dds::sub::DataReader<My::Type::Chat::Obj> reader(dds::sub::Subscriber(participant), cftopic);
